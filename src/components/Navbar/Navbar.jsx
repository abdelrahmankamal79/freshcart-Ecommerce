...
export default function Navbar() {
  ...
  let {wishNum }=useContext(WishContext);
  ...
  return (
    <>
      <nav className={`navbar navbar-expand-lg bg-main-light shadow-sm ${scroll}`}>
              ...
              <li className={`nav-item d-flex align-items-center me-2 ${style.social}`}>
                ...
                {userToken != null ? (
                  <Link className="position-relative" to={"cart"}>
                    <i className="fa-solid fa-cart-shopping me-3 fs-4"></i>
                ...
                {userToken != null ? (
                  <Link className="position-relative" to={"wishlist"}>
                    ...
                    <span className={`${style.count}`}>{wishNum}</span>
                  </Link>
                ) : (
                  ""
                )}
